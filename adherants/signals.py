...
def createProfile(sender, instance, created, **kwargs):
    try:
        ...
        print(f"Failed to create profile or send email for user {user.username}: {e}")
        # You can also use logging instead of print
        # import logging
        # logger = logging.getLogger(__name__)
        # logger.error(f"Failed to create profile or send email for user {user.username}: {e}")
